      ...
      <div class="container-fluid">
        ...
        <input type="checkbox" onclick="myFunction1()">Hiển thị mật khẩu
                    <script>function myFunction1() {
	                 ...
	                 <button type="reset" class="btn btn-danger"><i class="fa fa-times"></i>Huỷ </button>
	                    <button type="submit" class="btn btn-success"><i class="fa fa-check-square-o"></i>Chỉnh sửa </button>
	                </div> 
