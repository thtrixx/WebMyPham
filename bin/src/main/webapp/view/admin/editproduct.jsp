              ...
              <div class="card-body">
                ...
                <form method="post" action="${pageContext.request.contextPath}/admin/product/edit">
                 ...
                 <div class="form-group">
                    <label for="input-1">Id Sản phẩm</label>
                ...
                <div class="form-group">
                  <label for="input-2" class="col-form-label">Tóm tắt nội dung</label>
                  <div>
               ...
               <div class="form-footer">
                     <button class="btn btn-danger"><a href="${pageContext.request.contextPath}/admin/product/list">Huỷ</a></button>
