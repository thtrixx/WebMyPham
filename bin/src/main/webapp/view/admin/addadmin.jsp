                ...
                <form action="${pageContext.request.contextPath}/admin/admin/add" method="post"> 
                 ...
                 <div class="form-group"> 
                  ...
                  <div class="form-footer"> 
					  <button class="btn btn-danger"><i class="fa fa-times"></i><a href="${pageContext.request.contextPath}/admin/admin/list">Huỷ</a></button>
